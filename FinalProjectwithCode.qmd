...
educ_prop_df_long %>%
  ...
  geom_bar(position = position_fill(reverse = TRUE), stat="identity") + 
  labs(title = "Educational Outcome Distribution", caption = "From Representative sample from LAPOP in 2023", 
...
ggplot(SouthAmerica_only, aes(x = factor(skin_color))) +
  ...
  labs(title = "Self-reported skin color", x = "Skin color (from lighter to darker)", y = "Individuals in the sample", fill="Color")+
  theme_minimal()
