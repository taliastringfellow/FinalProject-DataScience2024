...
income_labels <- c("Entre $0 y $14.000 pesos", "Entre $14.001 y $26.000 pesos", "Entre $26.001 y $39.000 pesos",
            ...
            "Entre $136.001 y $168.000 pesos", "Entre $168.001 y $221.000 pesos", "Más de $221.000 pesos")
...
pop_geom <- sa_all_mapping %>%
  ...
  scale_fill_continuous_sequential(palette= "Heat 2")+
    labs(title = "Population by Country\n in Millions of Inhabitants", fill= "Pop. in millions")+
  theme_void()
...
le_geom <- sa_all_mapping %>%
  ...
  geom_sf_text(aes(label = round(lifeExp),2),
    size = 3.5,
    color = "black") +
  scale_fill_continuous_sequential(palette= "Heat 2")+
...
SouthAmerica_only %>%
  ...
  labs(fill = "Country Name", title = "Age distribution of Data by Country") +
  theme_minimal()
```
...
final_lasso_model <- tune::finalize_model(best_model) # THE MODEL STOPS WORKING HERE, TRIED MANY THINS. ASK ALENA.
